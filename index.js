...
function getDeck(url) {
	fetch(url)
		...
		.then((responseJson) => startGame(responseJson))
...
function shuffleDeck(url) {
	fetch(url)
		.then((response) => response.json())
		.then((responseJson) => resetGame(responseJson))
		.catch((error) => alert("That wasn't supposed to happen. Try again."));
}
								...
								: currentCard.value === '8'
									...
									: currentCard.value === '9'
										...
										: currentCard.value === '10'
											? count10--
											: currentCard.value === 'JACK'
												? countJ--
												: currentCard.value === 'QUEEN' ? countQ-- : countK--;
}
...
function calcProb() {
	if (currentCard.value === 'ACE') {
		...
		highProb = Math.round(
			(count3 + count4 + count5 + count6 + count7 + count8 + count9 + count10 + countJ + countQ + countK) /
				numberOfCards *
				100
		).toFixed(0);
		...
		highProb = Math.round(
			(count4 + count5 + count6 + count7 + count8 + count9 + count10 + countJ + countQ + countK) /
				numberOfCards *
				100
		).toFixed(0);
		...
		highProb = Math.round(
			(count5 + count6 + count7 + count8 + count9 + count10 + countJ + countQ + countK) / numberOfCards * 100
		).toFixed(0);
		...
		highProb = Math.round(
			(count6 + count7 + count8 + count9 + count10 + countJ + countQ + countK) / numberOfCards * 100
		).toFixed(0);
		...
		highProb = Math.round(
			(count7 + count8 + count9 + count10 + countJ + countQ + countK) / numberOfCards * 100
		).toFixed(0);
		...
		lowProb = Math.round(
			(countA + count2 + count3 + count4 + count5 + count6 + count7) / numberOfCards * 100
		).toFixed(0);
		...
		lowProb = Math.round(
			(countA + count2 + count3 + count4 + count5 + count6 + count7 + count8) / numberOfCards * 100
		).toFixed(0);
		...
		lowProb = Math.round(
			(countA + count2 + count3 + count4 + count5 + count6 + count7 + count8 + count9) / numberOfCards * 100
		).toFixed(0);
		...
		lowProb = Math.round(
			(countA + count2 + count3 + count4 + count5 + count6 + count7 + count8 + count9 + count10) /
				numberOfCards *
				100
		).toFixed(0);
		...
		lowProb = Math.round(
			(countA + count2 + count3 + count4 + count5 + count6 + count7 + count8 + count9 + count10 + countJ) /
				numberOfCards *
				100
		).toFixed(0);
